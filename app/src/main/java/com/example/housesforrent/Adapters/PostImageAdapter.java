...
//        this.context = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_select_image, parent, false);
...
//        holder.ivImageView.setImageURI(currentItem);
        ...
        Glide.with(holder.ivImageView.getContext()).load(currentItem.toString()).into(holder.ivImageView);
